...
@protocol CaptureScanDelegate <NSObject>
@optional
...
@interface CaptureScanViewController : UIViewController
...
- (void)setDelegate:(id<CaptureScanDelegate>)scanDelegate;
...
- (void)captureNextFrame:(CGRect)region;    // will call captured delegate to return frame in region
- (void)captureNextFrame;   // only avaliable when recognize process paused
                            // will call captured delegate to return frame
@end
